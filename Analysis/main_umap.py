...
def main():
    ...
    for target_task in range(0, opt.n_task):
        ...
        # --- タスク0 でだけ UMAP の fit & 軸範囲＆クラス数決定 ---
        ...
        # # タスクごとの開始クラスインデックス
        # task_class_indices = [
        #     (task_id * opt.cls_per_task, (task_id + 1) * opt.cls_per_task)
        #     for task_id in range(n_tasks)
        # ]
        # # print("task_class_indices: ", task_class_indices)   # task_class_indices:  [(0, 2), (2, 4), (4, 6), (6, 8), (8, 10)]
        ...
        #     emb_chunk   = embed[start:end]
        #     labels_chunk = labels[start:end]

        #     print("labels_chunk: ", labels_chunk)
        #     print("[palette[l] for l in labels_chunk]: ", [palette[l] for l in labels_chunk])
        #     assert False
        ...
        #         emb_chunk[:,0],
        #         emb_chunk[:,1],
        #         c=[palette[l] for l in labels_chunk],
        #         marker=[marker_list[l] for l in task_ids],
        #         s=10,
        #         alpha=0.5,
        #         label=f"{start}-{end-1}"  # 凡例にチャンク範囲を表示したい場合
        #     )
        ...
        plt.tight_layout()
        plt.savefig(f"./val{target_task}.pdf")
        plt.show()
