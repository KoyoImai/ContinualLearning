...
# 訓練用cifar10
#=========================
def set_loader_prco_cifar10(opt, normalize, replay_indices, model, training=True):
...
# 訓練用cifar100
#=========================
def set_loader_prco_cifar100(opt, normalize, replay_indices, model, training=True):
...
# 訓練用tiny-imagenet
#=========================
def set_loader_prco_tinyimagenet(opt, normalize, replay_indices, model, training=True):
