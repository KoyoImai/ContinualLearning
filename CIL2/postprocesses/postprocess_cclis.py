...
def postprocess_cclis(opt, model, model2, criterion, replay_indices):

    score_mask = model.module.score_mask
    val_loader = model.module.post_loader
    subset_sample_num = model.module.subset_sample_num
    val_targets = model.module.val_targets
    ...
    model.module.score = score
    model.module.score_mask = score_mask
