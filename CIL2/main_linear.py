...
from dataloaders import set_buffer, set_loader, set_loader_eval
...
def parse_option():
    ...
    parser.add_argument('--method', type=str, default='cclis', choices=['er', 'co2l', 'cclis', 'prco', 'prco-fimcl', 'prco-fimclv2', 'prco-fimclv3', 'prco-efm', 'prco-progefm'])
...
def main():
    ...
    dataloader = set_loader_eval(opt, model, replay_indices, method_tools)

    eval(model=model, dataloader=dataloader, opt=opt)
