...
# cifar10
python main.py --method er --mem_type ring --dataset cifar100 --batch_size 100 --seed 0\
               --grad_analysis --grad_analysis_freq 1 --print_freq 100 --learning_rate 0.03 --mem_size 2000 --epochs 50 --start_epoch 100 --log_name debug --date 2025_0804
