...
# 訓練用cifar10
def set_loader_cclis_bw_cifar10(opt, normalize, replay_indices, method_tools, training=True):
...
# 訓練用cifar100
def set_loader_cclis_bw_cifar100(opt, normalize, replay_indices, method_tools, training=True):
...
# 訓練用tiny-imagenet
def set_loader_cclis_bw_tinyimagenet(opt, normalize, replay_indices, method_tools, training=True):
